...
11. Install common data science packages. If you'd like to run the benchmarks above or work on other various data science and machine learning projects, you're likely going to need Jupyter Notebooks, NumPy for traditional machine learning algorithms and processing functions. \
Install Pyqt in the conda environment as well, i.e in the (my_env) inside (base). /

To test the installation of pyqt5, make sure you have done
```
brew install pyqt5
```
...
To test the installation of pyqt:
```bash
python -m pip install pixellib
```
If you are getting conflicts with the numpy versions, do:
```bash
...
15. Install common data science packages. If you'd like to run the benchmarks above or work on other various data science and machine learning projects, you're likely going to need Jupyter Notebooks, NumPy for traditional machine learning algorithms and processing functions. \
Install Pyqt in the conda environment as well, i.e in the (my_env) inside (base). /
